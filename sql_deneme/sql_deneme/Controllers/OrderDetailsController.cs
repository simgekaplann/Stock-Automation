...
namespace sql_deneme.Controllers
{
    ...
    public class OrderDetailsController : Controller
    {
        ...
        public OrderDetailsController(SqldenemeContext context)
        {
            _context = context;
        }
        ...
        {
            var sqldenemeContext = _context.OrderDetails.Include(o => o.Order).Include(o => o.Product);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SqldenemeContext.OrderDetails'  is null.");
            }
            var orderDetail = await _context.OrderDetails.FindAsync(id);
            if (orderDetail != null)
            {
