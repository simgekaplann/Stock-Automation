...
namespace sql_deneme.Controllers
{
    ...
    public class OrdersController : Controller
    {
        ...
        public OrdersController(SqldenemeContext context)
        {
            _context = context;
        }
        ...
        {
            var sqldenemeContext = _context.Orders.Include(o => o.Customer);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SqldenemeContext.Orders'  is null.");
            }
            var order = await _context.Orders.FindAsync(id);
            if (order != null)
            {
